...
EXTERN NSString * const CreateRoomRequest_KEY_MMO_DEFAULT_AOI;
EXTERN NSString * const CreateRoomRequest_KEY_MMO_MAP_LOW_LIMIT;
EXTERN NSString * const CreateRoomRequest_KEY_MMO_MAP_HIGH_LIMIT;
EXTERN NSString * const CreateRoomRequest_KEY_MMO_USER_MAX_LIMBO_SECONDS;
EXTERN NSString * const CreateRoomRequest_KEY_MMO_PROXIMITY_UPDATE_MILLIS;
EXTERN NSString * const CreateRoomRequest_KEY_MMO_SEND_ENTRY_POINT;
