...
@property (nonatomic, strong) BitSwarmClient *bitSwarm;
@property (nonatomic, strong) Logger *log;
@property (nonatomic, readwrite) NSInteger readState;
@property (nonatomic, strong) id <IProtocolCodec> codec;
@property (nonatomic, strong) PendingPacket *pendingPacket;
