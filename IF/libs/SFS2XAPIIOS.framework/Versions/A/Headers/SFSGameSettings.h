 ...
 */
@property (nonatomic, strong) NSArray *invitedPlayers;
/**
 Private games only: a list of room groups (Array of String) where to search for more players
 */
@property (nonatomic, strong) NSArray *searchableRooms;
/**
 ...
 @see MatchExpression
 */ 
@property (nonatomic, strong) MatchExpression *playerMatchExpression;
/**
 A MatchExpression for filtering Spectators joining the Game.
 
 @see MatchExpression
 */ 
@property (nonatomic, strong) MatchExpression *spectatorMatchExpression;
/**
 ...
 */ 
@property (nonatomic, strong) id <ISFSObject> invitationParams;
