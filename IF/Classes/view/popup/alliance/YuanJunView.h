...
#ifndef __IF__YuanJunView__
#define __IF__YuanJunView__
...
class YuanJunView: public PopupBaseView
...
{
public:
    static YuanJunCell* create(PlayerInfo* player);
    YuanJunCell(PlayerInfo* player):m_info(player){};
...
#endif /* defined(__IF__YuanJunView__) */
