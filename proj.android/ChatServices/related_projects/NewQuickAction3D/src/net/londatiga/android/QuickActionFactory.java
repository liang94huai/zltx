...
//				if (actionId == ID_COPY) {
//					Toast.makeText(activity.getApplicationContext(), "Let's do some search action", Toast.LENGTH_SHORT).show();
//				} else if (actionId == ID_SEND_MAIL) {
//					Toast.makeText(activity.getApplicationContext(), "I have no info this time", Toast.LENGTH_SHORT).show();
//				} else {
//					Toast.makeText(activity.getApplicationContext(), actionItem.getTitle() + " selected", Toast.LENGTH_SHORT).show();
//				}
//			}
//		});
