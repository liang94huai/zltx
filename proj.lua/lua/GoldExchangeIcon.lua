...
function GoldExchangeIcon:initSkeleton()
    ...
    elseif self.data[19] == "crystal_gift" then
        local bFile = LuaController:checkSkeletonFile(targetPlatform .. "sk_crystal_gift")
        if bFile == false then
            return
        end
        altas = self.rootPath .. "/skeleton/"..targetPlatform .."sk_crystal_gift.atlas"
        json = self.rootPath .. "/skeleton/"..targetPlatform .."sk_crystal_gift.json"
        aniName = "rukou"
        layerScale = 1
        layerX = -10
        layerY = -40
    elseif self.data[19] == "halloween" then
        local bFile = LuaController:checkSkeletonFile(targetPlatform .. "sk_halloween_icon")
        if bFile == false then
            return
        end
        altas = self.rootPath .. "/skeleton/"..targetPlatform .."sk_halloween_icon.atlas"
        json = self.rootPath .. "/skeleton/"..targetPlatform .."sk_halloween_icon.json"
        aniName = "sk_halloween"
        layerScale = 1
        layerX = -10
        layerY = -33
    ...
    self.m_ani1Layer:setPosition(ccp(layerX,layerY))
end
